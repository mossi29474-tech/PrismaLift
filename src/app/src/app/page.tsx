...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#050505] text-white p-6 md:p-12 tracking-tight">
      <nav className="flex justify-between items-center max-w-6xl mx-auto mb-16">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-black italic tracking-tighter text-white">PRISMALIFT</h1>
        </div>
        <button className="bg-[#ff4500] text-black px-6 py-2 rounded-sm font-black uppercase text-xs">
          New Session
        </button>
      </nav>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-[#111] border-t-2 border-[#ff4500] p-8">
          ...
          <h3 className="text-5xl font-black italic">12.4k <span className="text-lg text-slate-600 font-normal">LBS</span></h3>
        </div>
        ...
        <div className="bg-[#111] border-t-2 border-[#ff4500] p-8">
          ...
          <h3 className="text-5xl font-black italic">OPTIMAL</h3>
